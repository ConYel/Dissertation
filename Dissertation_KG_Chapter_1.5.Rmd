...
tiff(filename = file.path("FIG_20_IPP_1_2_COLO205.tiff"),
...
### Heatmap of comon piRNAs enriched with both Ab in IPP
...
tiff(filename = file.path("FIG_21_piRNA_common_AB1_AB2_Colo205.tiff"),
...
tiff(filename = file.path("FIG_22_piRNA_common_AB1_AB2_Meth_Cyt_Nuc.tiff"),
     compression = "none", height = 10, width = 14,  units = 'in', res = 600)
venn_piRNA
dev.off() 
```
